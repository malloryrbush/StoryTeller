...
namespace StoryTeller.Controllers
{
    public class WritersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "WriterID,FirstName,LastName,Birthday,NumberOfCont")] Writer writer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "WriterID,FirstName,LastName,Birthday,NumberOfCont")] Writer writer)
        {
            if (ModelState.IsValid)
            {
